...
1. **Smaller grids** (20-50) for faster execution
2. **Lower simulation speed** (100-200ms) for better visualization
3. **Use A*** for most scenarios - it's fast and optimal
4. **Use D* Lite** for dynamic environments with moving obstacles

## Troubleshooting

### Algorithm not finding path
- Check if start/end points are accessible
- Ensure no walls block the entire path
- Try different algorithm

### Simulation too fast/slow
- Adjust speed slider or use preset buttons
- Blazing (5ms) for fastest, Slow (200ms) for slowest

### ML confidence not increasing
- Run more algorithms (need at least 10-20 executions)
- Try different grid configurations
- Confidence increases as model learns patterns
